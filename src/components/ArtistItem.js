...
const ArtistItem = props => {
   ...
   if (props.image) {
      cardImage = config.artistsApiUrl + props.image;
   }
   ...
   if ((user && user.role === "admin") || (user && user._id === props.user)) {
      deleteIcon = <IconButton aria-label="delete" onClick={props.deleteArtistHandler}>
   ...
   let publicIcon;
   if ((user && user.role === "admin") || (user && user._id === props.user)) {
      publicIcon = <IconButton onClick={props.updArtistHandler}>
         <PublicIcon/>
      </IconButton>;
   } else {
      publicIcon = null;
      ...
      <Grid item>
         <Card className={cardStyle}>
            ...
            <CardMedia
               ...
               image={cardImage}
               component={Link} to={"/albums/" + props.id + "/" + props.name}
            />
            ...
            <CardActions>
               <IconButton component={Link} to={"/albums/" + props.id + "/" + props.name}>
                  <ArrowForwardIcon/>
               </IconButton>
               {deleteIcon}
               {publicIcon}
